 ...
 */
namespace GutenkitScopedDependencies\Composer;

use GutenkitScopedDependencies\Composer\Autoload\ClassLoader;
use GutenkitScopedDependencies\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('GutenkitScopedDependencies\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
