...
namespace GutenkitScopedDependencies\Wpmet\UtilityPackage\Helper;
...
class Helper
{
    ...
    {
        return \GutenkitScopedDependencies\Composer\InstalledVersions::getPrettyVersion('wpmet/utility-package');
    }
}
